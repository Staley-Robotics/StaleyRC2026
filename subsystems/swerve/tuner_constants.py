...
class TunerConstants:
    ...
    _slip_current: units.ampere = 40.0 # NOTE: default (max) is 120, dropping to 90 for current hopefully TODO: tune
    ...
    _front_left_encoder_offset: units.rotation = -0.337891 #
    ...
    _front_right_encoder_offset: units.rotation = -0.446777 #
    ...
    _back_left_encoder_id = 4
    _back_left_encoder_offset: units.rotation = 0.384766 # 
    ...
    _back_right_encoder_offset: units.rotation = 0.213135 # 
    ...
    @classmethod
    def create_drivetrain(cls) -> "SwerveDrive":
        """
